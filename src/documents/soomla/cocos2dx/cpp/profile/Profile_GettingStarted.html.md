...
7. You'll need to subscribe to profile events to get notified about social network related events. refer to the [Event Handling](/soomla/cocos2dx/cpp/profile/Profile_Events) section for more information.

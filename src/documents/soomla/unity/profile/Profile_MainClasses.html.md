...
`SoomlaProfile` is the class that needs to be initialized in order to begin using Profile. This is covered in unity3d-profile's [Getting Started](/soomla/unity/profile/Profile_GettingStarted) tutorial.

...
image: "Plugins"
title: "Unity Ads"
text: "With this integration you get your UnityAds metrics into GROW for smart analytics and better understanding on what's working and what isn't."
position: 5
theme: 'platforms'
...
## Integrating Grow with Unity Ads
...
1. In the games screen click on the "+" button to add a new game. If it's your first time in the dashboard, just click on the "+" button underneath the "Create your first game" label in the middle of the screen.
 ...
 Once you created your game, you'll be redirected to the Integrations page where you can start with any of the GROW integrations. Click on **Unity Ads**. You'll see the instructions screen, you can continue with that or stay here for the extended version.  
...
<br/>
Now you can build and run your app in order to verify it's Active in the [GROW Dashboard](http://dashboard.soom.la/) Unity Ads integration page, just refresh the page:

![alt text](/img/tutorial_img/unity_grow/ActiveIntegration_UnityAds.png "Unity Ads Integration")

That's it, you now have Unity Ads integrated with GROW and you can start working with GROW Analytics and see your Ad's performance!
